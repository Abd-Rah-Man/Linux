...
input_path='/home/abdrahman24434/data_pipeline/input'
output_path='/home/abdrahman24434/data_pipeline/output'
log_path='/home/abdrahman24434/data_pipeline/logs'

#Ingesting the data from source
echo -e "$(date)\nIngestion Begins..." >> $log_path/preprocess.log 
curl https://raw.githubusercontent.com/dataengineering-community/launchpad/refs/heads/main/Linux/sales_data.csv -o $input_path/sales_data.csv
